...
// StartMetricsServer khởi tạo và chạy một Prometheus metrics server trong một goroutine.
// Tham số 'network' dùng để chỉ định address family (ví dụ: "tcp4" cho IPv4, "tcp6" cho IPv6, hoặc "tcp").
